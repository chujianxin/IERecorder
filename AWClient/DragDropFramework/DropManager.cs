...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf0.Append('E');
#endif
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf1.Append('E');
#endif
        }
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf0.Append('O');
#endif
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf1.Append('O');
#endif
        }
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf0.Append('D');
#endif
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf1.Append('D');
#endif
        }
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf0.Append('L');
#endif
...
#if PRINT2BUFFER
            ((MainWindow)Application.Current.MainWindow).buf1.Append('L');
#endif
        }
